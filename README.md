About qiskit-finance-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/qiskit-finance-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qiskit-finance-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add qiskit-finance
# for installing globally
pixi global install qiskit-finance
```
...
It is possible to list all of the versions of `qiskit-finance` available on your platform:
...
```
pixi search qiskit-finance --channel conda-forge
```
